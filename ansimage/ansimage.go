...
var (
	...
	// ErrOutOfBounds happens when ANSI-pixel coordinates is out of ANSImage bounds
...
// ANSImage represents a image encoded in ANSI escape codes
...
// NewFromReader creates a new ANSImage from a io.Reader
...
// NewScaledFromReader creates a new scaled ANSImage from a io.Reader
...
// createANSImage loads data from a image and returns a ANSImage
